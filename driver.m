...
fprintf('\n');
fprintf('------------------------------------------------------------------------------------\n');
fprintf(['| ', datestr(now), ' - Start of Inverse Micro-Scale Atmospheric Dispersion Model |\n']);
fprintf('------------------------------------------------------------------------------------\n');
...
fprintf('\n');
fprintf('----------------------------------------------------------------------------------\n');
fprintf(['| ', datestr(now), ' - Control Parameters                                      |\n']);
fprintf('----------------------------------------------------------------------------------\n');
...
fprintf(['\n' datestr(now) ' - Creating Directories...\n']);
mkdir(iter_dir);
mkdir(conc_dir);
mkdir(obs_dir);
...
fprintf(['\n' datestr(now) ' - Computing spatial integration weight vector...\n']);
...
% is true.
fprintf(['\n' datestr(now) ' - Computing inverse of source error covariance matrix...\n']);
...
fprintf(['\n' datestr(now) ' - Computing observation matrix...\n']);
...
fprintf(['\n' datestr(now) ' - Computing discretized volumetric emission rate of known source...\n']);
